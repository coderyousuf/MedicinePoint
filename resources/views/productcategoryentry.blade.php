...
@section('titlename') Medicine Unit Entry @endsection
		...
		<section class="bg-section ysuccess pt-10 pb-10" data-black-overlay="8" style="background-image: url({{ asset('public/images/background/bg-2.jpg') }})">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-7">
						<i class="fa fa-home white"></i> <span> / Admin / Medicine Unit Entry</span>	
					</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control parsley-validated" name="CategoryName" id="CategoryName" data-required="true" placeholder="Enter Unit">
												</div>
											</div>
										</div>
...
jQuery("#addeditform").parsley({
	...
	function onConfirmWhenAddEdit() {
	    ...
	    $.ajax({
	        type: "post",
	        url: SITEURL+"/addEditProductCategoryRoute",
	...
	function onConfirmWhenDelete(recordId) {
		...
		$.ajax({
            type: "post",
            url: SITEURL+"/deleteProductCategoryRoute",
	...
	$(document).ready(function() {
		...
		tableMain = $("#tableMain").dataTable({
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('productcategorytabledatafetch') ?>",
		        "datatype": "json",
		        "type": "post",
		    ...
		    "fnDrawCallback" : function(oSettings) {
		            ...
		            $('a.itmDrop', tableMain.fnGetNodes()).each(function() {
		                ...
		                $(this).click(function() {
		                    ...
		                    buttons: {
		                        confirm: function () {
		                            onConfirmWhenDelete(aData['ProdCatId']);
		                        },
		                        cancel: function () {
		                            //$.alert('Canceled!');
		                        }
